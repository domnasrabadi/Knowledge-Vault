...
- An exploratory set of a small number of items (e.g., 2-5), used for manual experimentation and initial qualitative analysis of model behaviour. o A tuning set, used for iterating over prompts, parameters, and other elicitation choices. This should typically be 70-80% of the items.3 o An evaluation set, used only for the final reported evaluation after tuning is complete. This should typically be 20-30% of the items.
