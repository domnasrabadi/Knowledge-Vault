...
- Our panel consists of 9 judges from 7 model families (Table [1](https://arxiv.org/abs/2605.29800v1/#tab:judges)). All judges use temperature 0.0 and receive a standardized NLI classification prompt
...
- To test whether the independence deficit is a prompt or decoding artifact, we re-run all 9 judges on the same 1,000 MNLI items under four variants: (1) **reframed** wording, (2) **reversed** label order, (3) **chain-of-thought** reasoning, and (4) temperature $T = 0.5$
...
- (1) **Dawid-Skene EM** (Dawid and Skene, 1979), which estimates per-judge confusion matrices and true label posteriors via expectation-maximization without access to gold labels
...
- These results have direct practical implications. Paying for 9 opinions but receiving the informational equivalent of $\sim$2 is a substantial inefficiency: a 5-judge panel already captures 90% of achievable independence
