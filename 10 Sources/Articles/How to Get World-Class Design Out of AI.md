...
# How to Get World-Class Design Out of AI
...
- The way you set these loops up matters a lot. Here are some tips:
    ...
    - **Provide example images to demonstrate the target quality bar.** You can use comparable screenshots or designs you like, or even AI-generated concept art.
        - Instruct the critic to treat these as a baseline or a moodboard, not a target.
        - You don’t want it to copy other designs outright.
    ...
    - **Choose the right model for each job.** Consider bigger models for the critic role, since more parameters generally translate to better design sense and a wider distribution of ideas.
        - Small models can be effective as the implementer, but don’t go too small.
        - You still need a model that’s capable of executing a design direction well.
