...
status: raw
quality: 
topics: [llm-evaluation, evaluation-metrics, mlops, ai-engineering]
source: https://developers.openai.com/cookbook/examples/partners/eval_driven_system_design/receipt_inspection
created: 2026-08-16
published: 2025-06-02
author: Hugh Wimberly, Joshua Marker, Eddie Siegel, Shikhar Kwatra (OpenAI)
flashcards: none
updated: 2026-08-17
---
...
- Having our business model means we have a map of what’s worth doing and what isn’t. Our initial evals are a road sign that lets us know we’re moving in the right direction; but eventually we’ll need more signage.
