...
status: raw
quality:
topics: [agent-harnesses, communication, model-risk-validation]
...
1. The agent does most of the work
2. You can iterate as you use it
3. A skill is immediately valuable
4. A skill doesn’t have to be aggressively edited
